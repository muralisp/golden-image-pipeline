...
build {
  ...
  # this image can self-report drift
  provisioner "shell" {
    inline = [
      "sudo yum install -y openscap-scanner scap-security-guide",
      "sudo oscap xccdf eval --profile cis --report /var/log/cis-baseline-report.html /usr/share/xml/scap/ssg/content/ssg-*-ds.xml || true"
    ]
  }
